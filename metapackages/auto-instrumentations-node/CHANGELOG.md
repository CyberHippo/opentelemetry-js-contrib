...
## [0.29.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/auto-instrumentations-node-v0.28.0...auto-instrumentations-node-v0.29.0) (2022-05-11)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @opentelemetry/instrumentation-bunyan bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/instrumentation-cassandra-driver bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/instrumentation-connect bumped from ^0.27.0 to ^0.28.0
    ...
    * @opentelemetry/instrumentation-hapi bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/instrumentation-ioredis bumped from ^0.28.0 to ^0.29.0
    * @opentelemetry/instrumentation-knex bumped from ^0.27.0 to ^0.28.0
    * @opentelemetry/instrumentation-koa bumped from ^0.28.1 to ^0.29.0
    * @opentelemetry/instrumentation-memcached bumped from ^0.27.0 to ^0.28.0
    ...
    * @opentelemetry/instrumentation-net bumped from ^0.27.0 to ^0.28.0
